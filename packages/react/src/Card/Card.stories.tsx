...
export const Editing: Story = { args: { status: 'editing', title: 'Pushups', children: 'Ringed while being edited inline.' } };
export const Success: Story = { args: { status: 'success', title: 'Pushups', children: 'Filled green when all criteria are met.' } };
export const Skipped: Story = { args: { status: 'skipped', title: 'Pushups', children: 'Faded — does not apply today.' } };
