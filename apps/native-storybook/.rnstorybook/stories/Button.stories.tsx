...
import { Button } from '@valence/react-native';
...
const meta: Meta<typeof Button> = {
  ...
  argTypes: {
    kind: { control: 'select', options: ['primary', 'secondary', 'ghost', 'danger', 'dangerConfirm', 'pill'] },
  },
};
export default meta;
...
export const DangerConfirm: Story = { args: { kind: 'dangerConfirm', children: 'Tap again to confirm' } };
